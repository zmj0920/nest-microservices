...
import { FeishuAuthGuard } from '@/common/guards/feishu-auth.guard';
...
import { FeishuService } from '@/app/user/feishu/feishu.service';
...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      '通过 code 获取`access_token`https://open.feishu.cn/open-apis/authen/v1/user_auth_page_beta?app_id=cli_a25d66a31fba900b&redirect_uri=http%3A%2F%2F127.0.0.1%3A3000%2Fauth&state=',
  })
